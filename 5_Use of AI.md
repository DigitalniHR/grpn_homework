...
- **Codex as an opponent.** I used Codex to challenge the model and find possible bugs in the Sheet. For this task, Codex was more reliable than Claude when working with Google Sheets.
